        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=user&fitur=update" method="POST">
                    <input type="hidden" id="id_user" name="id_user" value="<?php echo htmlspecialchars($obj_user->id_user); ?>">
                    <!-- Nama Role -->
                    <div class="mb-4">
                    ...
                    <div class="mb-4 text-left">
                        ...
                        <textarea id="password" name="password" class="text-left shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" rows="3" required><?php echo isset($obj_user->password) ? htmlspecialchars($obj_user->password) : ''; ?></textarea>
                    </div>
                    
                    <!-- Role Status -->
                    <div class="mb-4">
                        <label for="nama_peran" class="block text-gray-700 text-sm font-bold mb-2">Role Name</label>
                        <select id="nama_peran" name="nama_peran" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required><?php echo isset($obj_user->nama_peran) ? htmlspecialchars($obj_user->nama_peran) : ''; ?>">
