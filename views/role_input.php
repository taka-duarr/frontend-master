            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=role&fitur=add" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="gaji" type = "number" name="gaji" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Masukkan gaji"  required>
                    </div>
